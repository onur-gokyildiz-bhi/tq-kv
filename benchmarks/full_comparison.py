...
def test_feature_matrix():
    ...
    features = [
        ...
        ("CUDA kernels (34 custom)", "YES", "No (llama.cpp GGML ops)"),
        ("cuBLAS SGEMM", "YES (native)", "Via llama.cpp backend"),
        ("CUDA Graph capture", "YES (2.3x)", "Via llama.cpp backend"),
        ...
        ("Platform", "CUDA + CPU (native)", "Metal + CUDA (via llama.cpp)"),
